...
| Run the tests | `python -m pytest -q` (84 spine) · `python -m pytest tests_gui -q` (154 GUI) · armor 8: WSL2 only, per [`journal/environment-armor.md`](../journal/environment-armor.md) |
